...
var s:string;
begin
if(MessageDlg('После проведения приказа его дальнейшее редактирование будет запрещено.Уверены что хотите продолжть?', mtConfirmation, [mbYes, mbNo], 0)=mrYes)then
begin
